 ...
 */
public class v1_16_R3Implement implements NMS {

    private static final MinecraftServer server = MinecraftServer.getServer();
    private static final WorldServer world = server.getWorlds().iterator().next();
    ...
    public void updateHeaderAndFooter(Player player, List<String> header, List<String> footer) {
        ...
        packet.header = IChatBaseComponent.ChatSerializer.a("{\"text\":\"" + StringEscapeUtils.escapeJava(this.getListFromString(CC.translate(header))) + "\"}");
        packet.footer = IChatBaseComponent.ChatSerializer.a("{\"text\":\"" + StringEscapeUtils.escapeJava(this.getListFromString(CC.translate(footer))) + "\"}");
